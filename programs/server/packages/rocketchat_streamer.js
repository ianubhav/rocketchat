...
var require = meteorInstall({"node_modules":{"meteor":{"rocketchat:streamer":{"lib":{"ev.js":["babel-runtime/helpers/classCallCheck",function(require,exports,module){
...
}]},"server":{"server.js":["babel-runtime/helpers/toConsumableArray","babel-runtime/helpers/createClass","babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require,exports,module){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var _toConsumableArray;module.import('babel-runtime/helpers/toConsumableArray',{"default":function(v){_toConsumableArray=v}});var _createClass;module.import('babel-runtime/helpers/createClass',{"default":function(v){_createClass=v}});var _classCallCheck;module.import('babel-runtime/helpers/classCallCheck',{"default":function(v){_classCallCheck=v}});var _possibleConstructorReturn;module.import('babel-runtime/helpers/possibleConstructorReturn',{"default":function(v){_possibleConstructorReturn=v}});var _inherits;module.import('babel-runtime/helpers/inherits',{"default":function(v){_inherits=v}});
                                                                                                                       //
                                                                                                                       //
                                                                                                                       //
                                                                                                                       //
                                                                                                                       //
/* globals EV */                                                                                                       // 1
/* eslint new-cap: false */                                                                                            // 2
                                                                                                                       //
var StreamerCentral = function (_EV) {                                                                                 //
	_inherits(StreamerCentral, _EV);                                                                                      //
                                                                                                                       //
	function StreamerCentral() {                                                                                          // 5
		_classCallCheck(this, StreamerCentral);                                                                              // 5
                                                                                                                       //
		var _this = _possibleConstructorReturn(this, _EV.call(this));                                                        // 5
                                                                                                                       //
		_this.instances = {};                                                                                                // 8
		return _this;                                                                                                        // 5
	}                                                                                                                     // 9
...
Meteor.Streamer = function (_EV2) {                                                                                    // 15
	_inherits(Streamer, _EV2);                                                                                            // 15
                                                                                                                       //
	function Streamer(name) {                                                                                             // 16
		var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};                                   // 16
                                                                                                                       //
		var _ref$retransmit = _ref.retransmit;                                                                               // 16
		var retransmit = _ref$retransmit === undefined ? true : _ref$retransmit;                                             // 16
		var _ref$retransmitToSelf = _ref.retransmitToSelf;                                                                   // 16
		var retransmitToSelf = _ref$retransmitToSelf === undefined ? false : _ref$retransmitToSelf;                          // 16
                                                                                                                       //
		_classCallCheck(this, Streamer);                                                                                     // 16
                                                                                                                       //
		if (Meteor.StreamerCentral.instances[name]) {                                                                        // 17
			var _ret;                                                                                                           // 17
                                                                                                                       //
			console.warn('Streamer instance already exists:', name);                                                            // 18
			return _ret = Meteor.StreamerCentral.instances[name], _possibleConstructorReturn(_this2, _ret);                     // 19
		}                                                                                                                    // 20
                                                                                                                       //
		var _this2 = _possibleConstructorReturn(this, _EV2.call(this));                                                      // 16
                                                                                                                       //
		...
		function isWriteAllowed(scope, eventName, args) {                                                                    // 15
			...
			if (this._allowWrite[eventName]) {                                                                                  // 193
				var _allowWrite$eventName;                                                                                         // 193
                                                                                                                       //
				return (_allowWrite$eventName = this._allowWrite[eventName]).call.apply(_allowWrite$eventName, [scope, eventName].concat(_toConsumableArray(args)));
			}                                                                                                                   // 195
                                                                                                                       //
			return (_allowWrite$__all__ = this._allowWrite['__all__']).call.apply(_allowWrite$__all__, [scope, eventName].concat(_toConsumableArray(args)));
		}                                                                                                                    // 198
                                                                                                                       //
		...
		function applyTransformers(methodScope, eventName, args) {                                                           // 15
			...
			if (this.transformers[eventName]) {                                                                                 // 248
				this.transformers[eventName].forEach(function (transform) {                                                        // 249
					args = transform.call.apply(transform, [methodScope].concat(_toConsumableArray(args)));                           // 250
	...
	Streamer.prototype.initMethod = function () {                                                                         // 15
		function initMethod() {                                                                                              // 15
			...
			method[this.subscriptionName] = function (eventName) {                                                              // 303
				for (var _len2 = arguments.length, args = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {   // 303
				...
				args = stream.applyTransformers(methodScope, eventName, args);                                                     // 320
                                                                                                                       //
				stream.emitWithScope.apply(stream, [eventName, methodScope].concat(_toConsumableArray(args)));                     // 322
                                                                                                                       //
			...
			subscriptions.forEach(function (subscription) {                                                                     // 346
				if (_this3.retransmitToSelf === false && origin && origin === subscription.subscription.connection) {              // 347
					return;                                                                                                           // 348
                                                                                                                       ...
                                                                                                                       //
				if (_this3.isEmitAllowed.apply(_this3, [subscription.subscription, eventName].concat(_toConsumableArray(args)))) {
	...
	_createClass(Streamer, [{                                                                                             // 15
		...
		set: function () {                                                                                                   // 15
			function set(retransmitToSelf) {                                                                                    // 15
